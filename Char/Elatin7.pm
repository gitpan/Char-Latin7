...
BEGIN {
    ...
    sub Char::Elatin7::binmode(*;$);
    sub Char::Elatin7::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Elatin7::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Elatin7::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Elatin7::chr(65) is "A" in either ASCII or Latin-7, and
  Char::Elatin7::chr(0x82a0) is a Latin-7 HIRAGANA LETTER A. For the reverse of Char::Elatin7::chr,
  use Char::Latin7::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Elatin7::binmode(FILEHANDLE, $disciplines);
  Char::Elatin7::binmode(FILEHANDLE);
  Char::Elatin7::binmode($filehandle, $disciplines);
  Char::Elatin7::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Elatin7::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Elatin7::open(FILEHANDLE, $expr);
  $rc = Char::Elatin7::open(FILEHANDLE);
  $rc = Char::Elatin7::open(my $filehandle, $mode, $expr);
  $rc = Char::Elatin7::open(my $filehandle, $expr);
  $rc = Char::Elatin7::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Elatin7::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Elatin7::open my $fh, ">logfile" or die ...
  ...
  Char::Elatin7::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Elatin7::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Elatin7::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Elatin7::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Elatin7::open(FH, "<:crlf:encoding(Char::Latin7)", $path) or die "can't open $path: $!";
