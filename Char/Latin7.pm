...
######################################################################
#
# Char::Latin7 - Source code filter to Latin-7 script
#
...
sub Char::Latin7::escape_script {
    ...
    if (/^ use Char::Elatin7(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin7 %s;\n%s", $Char::Elatin7::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin7 - Source code filter to escape Latin-7

=head1 SYNOPSIS

  use Char::Latin7;
  use Char::Latin7 version;         --- require version
