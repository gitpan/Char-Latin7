...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin7::function_ord     = 'Char::Latin7::ord'     if /\A ord \z/oxms;
                    $Char::Elatin7::function_ord_    = 'Char::Latin7::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin7::function_reverse = 'Char::Latin7::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin7::function_getc    = 'Char::Latin7::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin7::escape();
...
=head1 Calling 'Char::Elatin7::ignorecase()' (Char::Latin7 software provides)

Char::Latin7 software applies calling 'Char::Elatin7::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin7 software provides)

Char::Latin7 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin7 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin7 software provides)

Char::Latin7 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin7 software and
