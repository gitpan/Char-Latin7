...
10% everything else. But this "text" means US-ASCII text, and popular Latin-7
...
Perl3 or later can treat Latin-7.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Latin7 software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Latin-7, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Elatin7.pm.
  ...
  ${Char::Elatin7::not_space}      qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by Latin-7 designed for combining with
...
Contrasting is Encode module and describing "use Char::Latin7;" on this software,
