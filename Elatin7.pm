...
=item Make character
  ...
  set. For example, Elatin7::chr(65) is "A" in either ASCII or Latin-7, not Unicode,
  and Elatin7::chr(0x82a0) is a Latin-7 HIRAGANA LETTER A. For the reverse of
  Elatin7::chr, use Latin7::ord.
