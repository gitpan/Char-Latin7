...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Elatin7::uc($char[$i]) ne Elatin7::lc($char[$i]))) {
            $char[$i] = '[' . Elatin7::uc($char[$i]) . Elatin7::lc($char[$i]) . ']';
        }
...
=item * Only Latin7.pm and Elatin7.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Elatin7::lc
  lcfirst     Elatin7::lcfirst
  uc          Elatin7::uc
  ucfirst     Elatin7::ucfirst
  chr         Elatin7::chr
  glob        Elatin7::glob
  ---------------------------------
...
Latin7.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Elatin7.pm
  --------------------------------------------------------------------
  binmode(...);   Elatin7::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Elatin7::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Latin7 software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Latin7 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Latin7)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Elatin7.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Elatin7.pm provides bytes::*
