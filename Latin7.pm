...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin7 software provides)

Latin7 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin7 software provide)
