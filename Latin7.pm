...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ m/\A [\x00-\xFF] \z/oxms) and (Elatin7::uc($char[$i]) ne Elatin7::lc($char[$i]))) {
...
http://search.cpan.org/dist/Char-Latin7/Latin7/JA.pm
